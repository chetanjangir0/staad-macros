...
def ask_export_settings(
    ...
    millimetre_units = BooleanVar(master=window, value=True)
    ...
    ttk.Checkbutton(
        frame,
        text="Draw in millimetres (off: metres)",
        variable=millimetre_units,
    ).grid(row=8, column=0, pady=(6, 8), sticky="w")
    ...
    actions.grid(row=11, column=0, columnspan=2, pady=(18, 0), sticky="e")
